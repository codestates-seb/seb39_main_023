...
public class LoginController {
    ...
    public ResponseEntity<ChildCommonDto<ParentCommonDto>> refeshToken(@RequestParam String Authorization) {

        ChildCommonDto<ParentCommonDto> response = loginService.refreshToken(Authorization);
